...
function wp_bootstrap_starter_scripts() {
    ...
    //
    wp_enqueue_script('headroom-minjs', get_template_directory_uri() . '/inc/assets/js/headroom.min.js', array(), '', true );
    wp_enqueue_script('jQuery-headroomjs', get_template_directory_uri() . '/inc/assets/js/jQuery.headroom.js', array(), '', true );

    //OwlCarousel
    wp_enqueue_script('owlcarousel-js', get_template_directory_uri() . '/inc/assets/owlcarousel/owl.carousel.min.js', array(), '', true );
    wp_enqueue_style( 'owlcarousel-css', get_template_directory_uri() . '/inc/assets/owlcarousel/owl.carousel.min.css' );
    wp_enqueue_style( 'owlcarousel-theme-css', get_template_directory_uri() . '/inc/assets/owlcarousel/owl.theme.default.min.css' );
